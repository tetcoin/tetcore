...
benchmarks! {
	check_equivocation_proof {
		...
		const EQUIVOCATION_PROOF_BLOB: [u8; 416] = [
		 ...
		 [188, 192, 217, 91, 138, 78, 217, 80, 8, 29, 140, 55, 242, 210, 170, 184, 73, 98, 135,
		 212, 236, 209, 115, 52, 200, 79, 175, 172, 242, 161, 199, 47, 236, 93, 101, 95, 43, 34,
		141, 16, 247, 220, 33, 59, 31, 197, 27, 7, 196, 62, 12, 238, 236, 124, 136, 191, 29, 36, 22, 238, 242, 202, 57, 139]
		...
		println!("{:?}", Decode::decode(&mut &EQUIVOCATION_PROOF_BLOB[..]).unwrap());
	}: {
