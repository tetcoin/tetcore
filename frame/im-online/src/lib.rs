...
use sc_application_crypto::RuntimeAppPublic;
...
pub mod sr25519 {
	mod app_sr25519 {
		use sc_application_crypto::{app_crypto, key_types::IM_ONLINE, sr25519};
...
pub mod ed25519 {
	mod app_ed25519 {
		use sc_application_crypto::{app_crypto, key_types::IM_ONLINE, ed25519};
