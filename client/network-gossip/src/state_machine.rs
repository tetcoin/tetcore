...
// NOTE: The current value is adjusted based on largest production network deployment (Metrocoin) and
// the current main gossip user (GRANDPA). Currently there are ~800 validators on Metrocoin, as such,
