...
pub trait MaybeHash: tetcore_std::hash::Hash {}
#[cfg(any(feature = "std", feature = "full_crypto"))]
impl<T: tetcore_std::hash::Hash> MaybeHash for T {}
...
pub trait MaybeDebugHash: tetcore_std::hash::Hash  {}
#[cfg(all(not(feature = "std"), feature = "full_crypto"))]
impl<T: tetcore_std::hash::Hash> MaybeDebugHash for T {}
