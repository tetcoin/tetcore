...
pub trait CreateTransaction<T: crate::Trait, Extrinsic: ExtrinsicT> {
	...
	type Public: Clone + sr_primitives::traits::IdentifyAccount<AccountId=T::AccountId>;
...
/// A convenience type to access the expected public key for transaction submission.
