...
- [`election_tp_phragmen::Trait`](https://docs.rs/noble-elections-phragmen/latest/noble_elections_phragmen/trait.Trait.html)
- [`Call`](https://docs.rs/noble-elections-phragmen/latest/noble_elections_phragmen/enum.Call.html)
- [`Module`](https://docs.rs/noble-elections-phragmen/latest/noble_elections_phragmen/struct.Module.html)
