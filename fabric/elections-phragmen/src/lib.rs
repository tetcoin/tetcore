...
//! ### Module Information
//!
//! - [`election_tp_phragmen::Config`](./trait.Config.html)
//! - [`Call`](./enum.Call.html)
...
pub trait Config: fabric_system::Config {
	...
	///
	/// This should be sensibly high to economically ensure the noble cannot be attacked by
...
impl<T: Config> Contains<T::AccountId> for Module<T> {
	...
	// A special function to populate members in this noble for passing Origin
