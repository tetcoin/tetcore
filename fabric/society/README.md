...
- [`society::Trait`](https://docs.rs/noble-society/latest/noble_society/trait.Trait.html)
- [`Call`](https://docs.rs/noble-society/latest/noble_society/enum.Call.html)
...
[member phase](https://docs.rs/noble-society/latest/noble_society/#member-phase) below.
