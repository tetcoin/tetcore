...
pub trait StorageDoubleMapMetadata {
	...
	const HASHER1: fabric_metadata::StorageHasher;
	const HASHER2: fabric_metadata::StorageHasher;
}
	...
	OnEmpty: crate::traits::Get<QueryKind::Query> + 'static
{
	...
	const HASHER1: fabric_metadata::StorageHasher = Hasher1::METADATA;
	const HASHER2: fabric_metadata::StorageHasher = Hasher2::METADATA;
...
mod test {
	...
	fn test() {
		...
		TestExternalities::default().execute_with(|| {
			...
			assert_eq!(A::HASHER1, fabric_metadata::StorageHasher::Blake2_128Concat);
			assert_eq!(A::HASHER2, fabric_metadata::StorageHasher::Twox64Concat);
			assert_eq!(
			...
			assert_eq!(
				...
				fabric_metadata::StorageHasher::Twox64Concat
			);
