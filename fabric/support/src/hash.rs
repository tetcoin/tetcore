...
use tet_io::hashing::{blake2_128, blake2_256, twox_64, twox_128, twox_256};

// This trait must be kept coherent with fabric-support-procedural HasherKind usage
...
pub trait StorageHasher: 'static {
	const METADATA: fabric_metadata::StorageHasher;
...
impl StorageHasher for Identity {
	const METADATA: fabric_metadata::StorageHasher = fabric_metadata::StorageHasher::Identity;
	type Output = Vec<u8>;
	fn hash(x: &[u8]) -> Vec<u8> {
		x.to_vec()
	}
...
impl StorageHasher for Twox64Concat {
	const METADATA: fabric_metadata::StorageHasher = fabric_metadata::StorageHasher::Twox64Concat;
	type Output = Vec<u8>;
	fn hash(x: &[u8]) -> Vec<u8> {
		twox_64(x)
			.iter()
...
impl StorageHasher for Blake2_128Concat {
	const METADATA: fabric_metadata::StorageHasher = fabric_metadata::StorageHasher::Blake2_128Concat;
	type Output = Vec<u8>;
	fn hash(x: &[u8]) -> Vec<u8> {
		blake2_128(x)
			.iter()
...
impl StorageHasher for Blake2_128 {
	const METADATA: fabric_metadata::StorageHasher = fabric_metadata::StorageHasher::Blake2_128;
	type Output = [u8; 16];
	fn hash(x: &[u8]) -> [u8; 16] {
		blake2_128(x)
	}
...
impl StorageHasher for Blake2_256 {
	const METADATA: fabric_metadata::StorageHasher = fabric_metadata::StorageHasher::Blake2_256;
	type Output = [u8; 32];
	fn hash(x: &[u8]) -> [u8; 32] {
		blake2_256(x)
	}
...
impl StorageHasher for Twox128 {
	const METADATA: fabric_metadata::StorageHasher = fabric_metadata::StorageHasher::Twox128;
	type Output = [u8; 16];
	fn hash(x: &[u8]) -> [u8; 16] {
		twox_128(x)
	}
...
impl StorageHasher for Twox256 {
	const METADATA: fabric_metadata::StorageHasher = fabric_metadata::StorageHasher::Twox256;
	type Output = [u8; 32];
	fn hash(x: &[u8]) -> [u8; 32] {
		twox_256(x)
	}
