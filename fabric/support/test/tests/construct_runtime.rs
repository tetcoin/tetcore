...
use tp_runtime::{generic, traits::{BlakeTwo256, Verify}, DispatchError};
use tet_core::{H256, sr25519};
use tetcore_std::cell::RefCell;
use fabric_support::traits::NobleInfo as _;
...
mod module1 {
	...
	fabric_support::decl_module! {
		...
		{
			#[weight = 0]
			pub fn fail(_origin) -> fabric_support::dispatch::DispatchResult {
...
#[test]
fn noble_in_runtime_is_correct() {
	assert_eq!(NobleInfo::index::<System>().unwrap(), 30);
	assert_eq!(NobleInfo::name::<System>().unwrap(), "System");

	assert_eq!(NobleInfo::index::<Module1_1>().unwrap(), 31);
	assert_eq!(NobleInfo::name::<Module1_1>().unwrap(), "Module1_1");

	assert_eq!(NobleInfo::index::<Module2>().unwrap(), 32);
	assert_eq!(NobleInfo::name::<Module2>().unwrap(), "Module2");

	assert_eq!(NobleInfo::index::<Module1_2>().unwrap(), 33);
	assert_eq!(NobleInfo::name::<Module1_2>().unwrap(), "Module1_2");

	assert_eq!(NobleInfo::index::<Module1_3>().unwrap(), 6);
	assert_eq!(NobleInfo::name::<Module1_3>().unwrap(), "Module1_3");

	assert_eq!(NobleInfo::index::<Module1_4>().unwrap(), 3);
	assert_eq!(NobleInfo::name::<Module1_4>().unwrap(), "Module1_4");

	assert_eq!(NobleInfo::index::<Module1_5>().unwrap(), 4);
	assert_eq!(NobleInfo::name::<Module1_5>().unwrap(), "Module1_5");

	assert_eq!(NobleInfo::index::<Module1_6>().unwrap(), 1);
	assert_eq!(NobleInfo::name::<Module1_6>().unwrap(), "Module1_6");

	assert_eq!(NobleInfo::index::<Module1_7>().unwrap(), 2);
	assert_eq!(NobleInfo::name::<Module1_7>().unwrap(), "Module1_7");

	assert_eq!(NobleInfo::index::<Module1_8>().unwrap(), 12);
	assert_eq!(NobleInfo::name::<Module1_8>().unwrap(), "Module1_8");

	assert_eq!(NobleInfo::index::<Module1_9>().unwrap(), 13);
	assert_eq!(NobleInfo::name::<Module1_9>().unwrap(), "Module1_9");
}
