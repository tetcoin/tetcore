...
use fabric_support::storage::unhashed;
use codec::Encode;
use fabric_support::{StorageDoubleMap, StorageMap, StorageValue, StoragePrefixedMap};
...
mod instance {
	pub trait Config<I = DefaultInstance>: fabric_support_test::Config {}

	fabric_support::decl_module! {
		pub struct Module<T: Config<I>, I: Instance = DefaultInstance>
			for enum Call where origin: T::Origin, system=fabric_support_test {}
	}
