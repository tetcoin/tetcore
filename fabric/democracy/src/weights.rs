...
// --steps=50
// --repeat=20
// --noble=noble_democracy
// --extrinsic=*
// --execution=wasm
// --wasm-execution=compiled
// --heap-pages=4096
// --output=./fabric/democracy/src/weights.rs
...
/// Weight functions needed for noble_democracy.
...
/// Weights for noble_democracy using the Tetcore node and recommended hardware.
