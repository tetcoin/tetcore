...
- [`democracy::Trait`](https://docs.rs/noble-democracy/latest/noble_democracy/trait.Trait.html)
- [`Call`](https://docs.rs/noble-democracy/latest/noble_democracy/enum.Call.html)
