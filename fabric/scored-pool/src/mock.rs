...
use super::*;
use crate as noble_scored_pool;

use std::cell::RefCell;
use fabric_support::{parameter_types, ord_parameter_types};
use tet_core::H256;
use tp_runtime::{
...
fabric_support::construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		ScoredPool: noble_scored_pool::{Module, Call, Storage, Config<T>, Event<T>},
	}
);
...
pub fn new_test_ext() -> tet_io::TestExternalities {
	...
	noble_scored_pool::GenesisConfig::<Test>{
		pool: vec![
			(5, None),
			(10, Some(1)),
			(20, Some(2)),
