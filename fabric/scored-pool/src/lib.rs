...
//! ## Dependencies
//!
//! This module depends on the [System module](../fabric_system/index.html).
...
use tp_runtime::traits::{AtLeast32Bit, MaybeSerializeDeserialize, Zero, StaticLookup};

type BalanceOf<T, I> = <<T as Config<I>>::Currency as Currency<<T as fabric_system::Config>::AccountId>>::Balance;
type PoolT<T, I> = Vec<(<T as fabric_system::Config>::AccountId, Option<<T as Config<I>>::Score>)>;
