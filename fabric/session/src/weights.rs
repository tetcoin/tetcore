...
// --heap-pages=4096
// --output=./fabric/session/src/weights.rs
...
/// Weight functions needed for noble_session.
...
/// Weights for noble_session using the Tetcore node and recommended hardware.
