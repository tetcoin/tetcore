...
//!
//! - [`Currency`](../fabric_support/traits/trait.Currency.html): Functions for dealing with a
//! fungible assets system.
//! - [`ReservableCurrency`](../fabric_support/traits/trait.ReservableCurrency.html):
//! Functions for dealing with assets that can be reserved from an account.
//! - [`LockableCurrency`](../fabric_support/traits/trait.LockableCurrency.html): Functions for
//! dealing with accounts that allow liquidity restrictions.
//! - [`Imbalance`](../fabric_support/traits/trait.Imbalance.html): Functions for handling
//! imbalances between total issuance in the system and account balances. Must be used when a function
//! creates new funds (e.g. a reward) or destroys some funds (e.g. a system fee).
//! - [`IsDeadAccount`](../fabric_support/traits/trait.IsDeadAccount.html): Determiner to say whether a
...
//! # 	stash: <T as fabric_system::Config>::AccountId,
//! # 	total: <<T as Config>::Currency as fabric_support::traits::Currency<<T as fabric_system::Config>::AccountId>>::Balance,
...
use fabric_system::{self as system, ensure_signed, ensure_root};
pub use self::imbalances::{PositiveImbalance, NegativeImbalance};
pub use weights::WeightInfo;

pub trait Subtrait<I: Instance = DefaultInstance>: fabric_system::Config {
	...
	/// Weight information for the extrinsics in this noble.
...
decl_module! {
	pub struct Module<T: Config<I>, I: Instance = DefaultInstance> for enum Call where origin: T::Origin {
		...
		/// it will reset the account nonce (`fabric_system::AccountNonce`).
		///
