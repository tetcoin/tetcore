...
use fabric_support::{decl_module, decl_event, impl_outer_origin, impl_outer_event};
use tet_core::H256;
...
fabric_support::parameter_types! {
	...
	pub BlockWeights: fabric_system::limits::BlockWeights =
		fabric_system::limits::BlockWeights::with_sensible_defaults(
			4 * 1024 * 1024, Perbill::from_percent(75),
		);
	pub BlockLength: fabric_system::limits::BlockLength =
		fabric_system::limits::BlockLength::max_with_normal_ratio(
			4 * 1024 * 1024, Perbill::from_percent(75),
		);
}
