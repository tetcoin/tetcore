...
type NegativeImbalanceOf<C, T> =
	<C as Currency<<T as fabric_system::Config>::AccountId>>::NegativeImbalance;
...
/// trait (eg. the noble_balances) using an unbalance handler (implementing
/// `OnUnbalanced`).
...
where
	T: Config,
	T::TransactionByteFee: Get<<C as Currency<<T as fabric_system::Config>::AccountId>>::Balance>,
	C: Currency<<T as fabric_system::Config>::AccountId>,
	C::PositiveImbalance:
		Imbalance<<C as Currency<<T as fabric_system::Config>::AccountId>>::Balance, Opposite = C::NegativeImbalance>,
	C::NegativeImbalance:
		Imbalance<<C as Currency<<T as fabric_system::Config>::AccountId>>::Balance, Opposite = C::PositiveImbalance>,
	OU: OnUnbalanced<NegativeImbalanceOf<C, T>>,
{
	type LiquidityInfo = Option<NegativeImbalanceOf<C, T>>;
	type Balance = <C as Currency<<T as fabric_system::Config>::AccountId>>::Balance;
