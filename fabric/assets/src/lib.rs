...
//! * **Zombie**: An account which has a balance of some assets in this noble, but no other
//!   footprint on-chain, in particular no account managed in the `fabric_system` noble.
//!
//! ### Goals
//!
...
//! ## Related Modules
//!
//! * [`System`](../fabric_system/index.html)
//! * [`Support`](../fabric_support/index.html)
