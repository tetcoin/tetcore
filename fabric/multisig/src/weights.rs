...
// --steps=50
// --repeat=20
// --noble=noble_multisig
// --extrinsic=*
// --execution=wasm
// --wasm-execution=compiled
// --heap-pages=4096
// --output=./fabric/multisig/src/weights.rs
...
/// Weight functions needed for noble_multisig.
...
/// Weights for noble_multisig using the Tetcore node and recommended hardware.
