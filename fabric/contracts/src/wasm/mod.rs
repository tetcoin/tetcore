...
use noble_contracts_primitives::ExecResult;
	...
	T::AccountId: UncheckedFrom<T::Hash> + AsRef<[u8]>
{
	...
	fn execute<E: Ext<T = T>>(
		...
		let memory =
			tp_sandbox::Memory::new(exec.prefab_module.initial, Some(exec.prefab_module.maximum))
				.unwrap_or_else(|_| {
...
mod tests {
	...
	use fabric_support::{dispatch::DispatchResult, weights::Weight};
	use assert_matches::assert_matches;
	use noble_contracts_primitives::{ExecReturnValue, ReturnFlags, ExecError, ErrorOrigin};
