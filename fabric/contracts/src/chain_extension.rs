...
//! trait and declares it in this noble's [configuration Trait](crate::Config). All types
...
//! # Benchmarking
//!
//! The builtin contract callable functions that noble-contracts provides all have
...
pub use fabric_system::Config as SysConfig;
pub use noble_contracts_primitives::ReturnFlags;
...
/// to the noble contracts configuration trait as the associated type of the same name.
