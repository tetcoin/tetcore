...
- [`contract::Trait`](https://docs.rs/noble-contracts/latest/noble_contracts/trait.Trait.html)
- [`Call`](https://docs.rs/noble-contracts/latest/noble_contracts/enum.Call.html)
...
* [`pro`](https://github.com/tetcoin/pro) is
an [`eDSL`](https://wiki.haskell.org/Embedded_domain_specific_language) that enables writing
WebAssembly based smart contracts in the Rust programming language. This is a work in progress.

## Related Modules

* [Balances](https://docs.rs/noble-balances/latest/noble_balances/)
