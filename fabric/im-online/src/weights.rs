...
// --steps=50
// --repeat=20
// --noble=noble_im_online
// --extrinsic=*
// --execution=wasm
// --wasm-execution=compiled
// --heap-pages=4096
// --output=./fabric/im-online/src/weights.rs
...
/// Weight functions needed for noble_im_online.
pub trait WeightInfo {
	fn validate_unsigned_and_then_heartbeat(k: u32, e: u32, ) -> Weight;

}

/// Weights for noble_im_online using the Tetcore node and recommended hardware.
