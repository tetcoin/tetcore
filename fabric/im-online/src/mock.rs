...
impl noble_session::SessionManager<u64> for TestSessionManager {
...
impl noble_session::historical::SessionManager<u64, u64> for TestSessionManager {
...
pub fn new_test_ext() -> tet_io::TestExternalities {
	let t = fabric_system::GenesisConfig::default()
...
impl noble_session::Config for Runtime {
	...
	type SessionManager = noble_session::historical::NoteHistoricalRoot<Runtime, TestSessionManager>;
...
impl<LocalCall> fabric_system::offchain::SendTransactionTypes<LocalCall> for Runtime where
	Call: From<LocalCall>,
{
...
pub type System = fabric_system::Module<Runtime>;
pub type Session = noble_session::Module<Runtime>;
