...
//! And in a runtime context, so that the BABE noble can validate the
//! equivocation proofs in the extrinsic and report the offences.
//!
//! IMPORTANT:
//! When using this module for enabling equivocation reporting it is required
//! that the `ValidateUnsigned` for the BABE noble is used in the runtime
//! definition.
//!
...
/// using existing subsystems that are part of fabric (type bounds described
...
where
	// We use the authorship noble to fetch the current block author and use
