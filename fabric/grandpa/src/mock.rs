...
impl_outer_dispatch! {
	pub enum Call for Test where origin: Origin {
		noble_grandpa::Grandpa,
		noble_staking::Staking,
	}
}
...
pub type Historical = noble_session::historical::Module<Test>;
pub type Offences = noble_offences::Module<Test>;
...
pub type Timestamp = noble_timestamp::Module<Test>;
...
pub fn new_test_ext(vec: Vec<(u64, u64)>) -> tet_io::TestExternalities {
	new_test_ext_raw_authorities(to_authorities(vec))
}

pub fn new_test_ext_raw_authorities(authorities: AuthorityList) -> tet_io::TestExternalities {
