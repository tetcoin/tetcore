...
//! Staking noble benchmarking.

use super::*;

use fabric_system::RawOrigin as SystemOrigin;
use fabric_system::EventRecord;
use fabric_benchmarking::{benchmarks_instance, account, whitelisted_caller};
use tp_runtime::traits::Bounded;
use tetcore_std::mem::size_of;

use fabric_system::Call as SystemCall;
use fabric_system::Module as System;
...
benchmarks_instance! {
	...
	vote {
		...
		let voter_key = fabric_system::Account::<T>::hashed_key_for(&voter);
		fabric_benchmarking::benchmarking::add_to_whitelist(voter_key.into());
