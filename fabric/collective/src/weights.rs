...
// --steps=50
// --repeat=20
// --noble=noble_collective
// --extrinsic=*
// --execution=wasm
// --wasm-execution=compiled
// --heap-pages=4096
// --output=./fabric/collective/src/weights.rs
...
/// Weight functions needed for noble_collective.
...
/// Weights for noble_collective using the Tetcore node and recommended hardware.
