...
pub trait Config<I: Instance=DefaultInstance>: fabric_system::Config {
	...
	/// + This noble assumes that dependents keep to the limit without enforcing it.
...
/// Origin for the collective module.
pub type Origin<T, I=DefaultInstance> = RawOrigin<<T as fabric_system::Config>::AccountId, I>;
...
decl_module! {
	pub struct Module<T: Config<I>, I: Instance=DefaultInstance> for enum Call where origin: <T as fabric_system::Config>::Origin {
...
impl<T: Config<I>, I: Instance> Module<T, I> {
	...
	// Removes a proposal from the noble, cleaning up votes and the vector of proposals.
...
mod tests {
	use super::*;
	use fabric_support::{Hashable, assert_ok, assert_noop, parameter_types};
	...
	fn make_proposal(value: u64) -> Call {
		Call::System(fabric_system::Call::remark(value.encode()))
	}
