...
impl noble_session::OneSessionHandler<AccountId> for OtherSessionHandler {
...
impl FindAuthor<AccountId> for Author11 {
	fn find_author<'a, I>(_digests: I) -> Option<AccountId>
		where I: 'a + IntoIterator<Item = (fabric_support::ConsensusEngineId, &'a [u8])>,
	{
		Some(11)
	}
}
...
parameter_types! {
	...
	pub BlockWeights: fabric_system::limits::BlockWeights =
		fabric_system::limits::BlockWeights::simple_max(
			fabric_support::weights::constants::WEIGHT_PER_SECOND * 2
		);
...
impl<LocalCall> fabric_system::offchain::SendTransactionTypes<LocalCall> for Test
where
	Call: From<LocalCall>,
{
...
impl ExtBuilder {
	...
	pub fn build(self) -> tet_io::TestExternalities {
		...
		let mut storage = fabric_system::GenesisConfig::default()
			.build_storage::<Test>()
			.unwrap();
		...
		let _ = noble_session::GenesisConfig::<Test> {
...
pub(crate) fn on_offence_in_era(
	offenders: &[OffenceDetails<
		AccountId,
		noble_session::historical::IdentificationTuple<Test>,
	>],
...
pub(crate) fn on_offence_now(
	offenders: &[OffenceDetails<AccountId, noble_session::historical::IdentificationTuple<Test>>],
	slash_fraction: &[Perbill],
) {
