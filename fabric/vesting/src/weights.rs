...
// --heap-pages=4096
// --output=./fabric/vesting/src/weights.rs
...
/// Weight functions needed for noble_vesting.
...
/// Weights for noble_vesting using the Tetcore node and recommended hardware.
