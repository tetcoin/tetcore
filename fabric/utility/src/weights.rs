...
// --heap-pages=4096
// --output=./fabric/utility/src/weights.rs
...
/// Weight functions needed for noble_utility.
...
/// Weights for noble_utility using the Tetcore node and recommended hardware.
