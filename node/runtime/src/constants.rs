...
pub mod currency {
	...
	pub const MILLICENTS: Balance = Balance::from(1_000_000_000u32);
	pub const CENTS: Balance = Balance::from(1_000u32) * MILLICENTS;    // assume this is worth about a cent.
	pub const DOLLARS: Balance = Balance::from(100u32) * CENTS;
}
