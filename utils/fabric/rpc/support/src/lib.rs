...
//! Combines [tc_rpc_api::state::StateClient] with [fabric_support::storage::generator] traits
...
use fabric_support::storage::generator::{
...
/// # use tetcore_fabric_rpc_support::StorageQuery;
/// # use fabric_system::Config;
/// # use tc_rpc_api::state::StateClient;
/// #
/// # // Hash would normally be <TestRuntime as fabric_system::Config>::Hash, but we don't have
/// # // fabric_system::Config implemented for TestRuntime. Here we just pretend.
/// # type Hash = ();
/// #
...
impl<V: FullCodec> StorageQuery<V> {
	...
	///
	/// Hash should be <YourRuntime as fabric::Config>::Hash.
	///
	/// # Arguments
	///
