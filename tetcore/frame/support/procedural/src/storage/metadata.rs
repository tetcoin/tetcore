...
fn default_byte_getter(
	...
	let struct_def = quote! {
		...
		>(pub #scrate::tetcore_std::marker::PhantomData<(#runtime_generic #optional_comma_instance)>);

		#[cfg(feature = "std")]
		#[allow(non_upper_case_globals)]
		static #cache_name: #scrate::once_cell::sync::OnceCell<#scrate::tetcore_std::vec::Vec<u8>> =
		...
		impl<#runtime_generic: #runtime_trait, #optional_instance_bound>
			...
			#where_clause
		{
			fn default_byte(&self) -> #scrate::tetcore_std::vec::Vec<u8> {
	...
	let struct_instance = quote!(
		#struct_name::<#runtime_generic, #optional_instance>(#scrate::tetcore_std::marker::PhantomData)
	);
